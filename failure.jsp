      ...
      <div class="mainbar">
        <div class="article">
          <form id="form2" name="form2" method="post" action="login">
            <table width="352" height="259" border="0">
              <tr>
                <td><span class="style2">User Name:</span></td>
                <td><input type="text" id="username" name="username" class="login_input" /></td>
              </tr>
              <tr>
            ...
            <p><span class="style15">User Credentials are invalid... </span></p>
          </form>
          <h2>&nbsp;</h2>
